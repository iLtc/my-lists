const books = [
    {
        ...
        'items': [
            ...
            },
            {
                ...
                'image': ['ChronicleOfABloodMerchant.jpg', 'ChronicleOfABloodMerchantCN.jpeg'],
                'author': ['Yu Hua', '余华']
            },
            {
                'title': ['To Live', '活着'],
            ...
            },
            {
                ...
                'image': ['IDeliverExpressInBeijing.jpeg', 'IDeliverExpressInBeijing.jpeg'],
                'author': ['Hu Anyan', '胡安焉']
            },
            {
                'title': ['The Pragmatic Programmer', '程序员修炼之道'],
                'image': ['ThePragmaticProgrammer.jpeg', 'ThePragmaticProgrammer.jpeg'],
    ...
    },
    {
        ...
        'items': [
            ...
            },
            {
                ...
                'image': ['TheFellowshipOfTheRing.jpeg', 'TheFellowshipOfTheRing.jpeg'],
                'author': ['J. R. R. Tolkien', 'J·R·R·托尔金']
            },
            {
            ...
            },
            {
                ...
                'image': ['TheCodingCareerHandbook.jpeg', 'TheCodingCareerHandbook.jpeg'],
    ...
    },
    {
        ...
        'items': [
            ...
            },
            {
                ...
                'image': [
                    'TheMidnightLibrary.jpg',
                    'TheMidnightLibraryCN.jpg'
                ],
            ...
            },
            {
                ...
                'image': [
                    'TheHandmaidsTale.jpg',
                    'TheHandmaidsTaleCN.jpg'
                ],
        ...
        'items': [
            {
                ...
                'image': ['FangSichisFirstLoveParadise.jpg', 'FangSichisFirstLoveParadise.jpg'],
            ...
            },
            {
                ...
                'image': ['EagleSoaringInTheNinthMonth.jpg', 'EagleSoaringInTheNinthMonth.jpg'],
                'author': ['Gu Long', '古龙']
            },
            {
            ...
            },
            {
                ...
                'image': ['SentimentalSwordsmanRuthlessSword.jpg', 'SentimentalSwordsmanRuthlessSword.jpg'],
                'author': ['Gu Long', '古龙']
            },
            {
            ...
            },
            {
                ...
                'image': ['SharksFinAndSichuanPepper.jpg', 'SharksFinAndSichuanPepper.jpg'],
            ...
            },
            {
                ...
                'image': ['TheLastMonkeyPerformer.jpg', 'TheLastMonkeyPerformer.jpg'],
                'author': ['马宏杰', '马宏杰']
            },
            {
            ...
            },
            {
                ...
                'image': ['DeliveredFromDistraction.jpg', 'DeliveredFromDistraction.jpg'],
    ...
    },
    {
        ...
        'items': [
            ...
            },
            {
                ...
                'image': ['TheLongestDayInChangan.jpg', 'TheLongestDayInChangan.jpg'],
                'author': ['Ma Boyong', '马伯庸']
            },
            {
            ...
            },
            {
                ...
                'image': ['TheGirlWithSevenNames.jpg', 'TheGirlWithSevenNames.jpg'],
            ...
            },
            {
                ...
                'image': ['HowToStopWorryingAndStartLiving.jpg', 'HowToStopWorryingAndStartLiving.jpg'],
                'author': ['Dale Carnegie', '戴尔·卡耐基']
            },
            {
                'title': ['Reaching the Southern Hemisphere, Everything Changed', '到了南半球，一切都变了'],
                'image': ['ReachingTheSouthernHemisphereEverythingChanged.jpg', 'ReachingTheSouthernHemisphereEverythingChanged.jpg'],
                'author': ['刘小顺', '刘小顺']
            },
            {
                'title': ['How to Win Friends and Influence People', '人性的弱点'],
                'image': ['HowToWinFriendsAndInfluencePeople.jpg', 'HowToWinFriendsAndInfluencePeople.jpg'],
                'author': ['Dale Carnegie', '戴尔·卡耐基']
            },
            {
            ...
            },
            {
                ...
                'image': ['WatchDogsTheDedsecRevenge.jpg', 'WatchDogsTheDedsecRevenge.jpg'],
        ...
        'items': [
            {
                ...
                'image': ['DailyLifeInTheRomanCity.jpg', 'DailyLifeInTheRomanCity.jpg'],
            ...
            },
            {
                ...
                'image': ['TheCompleteSoftwareDevelopersCareerGuide.jpeg', 'TheCompleteSoftwareDevelopersCareerGuide.jpeg'],
            ...
            },
            {
                ...
                'image': ['HarryPotterAndTheDeathlyHallows.jpg', 'HarryPotterAndTheDeathlyHallows.jpg'],
        ...
        'items': [
            {
                ...
                'image': ['HarryPotterAndTheHalfbloodPrince.jpg', 'HarryPotterAndTheHalfbloodPrince.jpg'],
                'author': ['J.K. Rowling', 'J·K·罗琳']
            },
            {
                'title': ['Harry Potter and the Order of the Phoenix', '哈利·波特与凤凰社'],
                'image': ['HarryPotterAndTheOrderOfThePhoenix.jpg', 'HarryPotterAndTheOrderOfThePhoenix.jpg'],
                'author': ['J.K. Rowling', 'J·K·罗琳']
            },
            {
                'title': ['Quantum Break: Zero State', 'Quantum Break: Zero State'],
                'image': ['QuantumBreakZeroState.jpg', 'QuantumBreakZeroState.jpg'],
                'author': ['Cam Rogers', 'Cam Rogers']
            },
            {
                'title': ['Harry Potter and the Goblet of Fire', '哈利·波特与火焰杯'],
                'image': ['HarryPotterAndTheGobletOfFire.jpg', 'HarryPotterAndTheGobletOfFire.jpg'],
                'author': ['J.K. Rowling', 'J·K·罗琳']
            },
            {
                'title': ['Harry Potter and the Prisoner of Azkaban', '哈利·波特与阿兹卡班囚徒'],
                'image': ['HarryPotterAndThePrisonerOfAzkaban.jpg', 'HarryPotterAndThePrisonerOfAzkaban.jpg'],
                'author': ['J.K. Rowling', 'J·K·罗琳']
            },
            {
                'title': ['Harry Potter and the Chamber of Secrets', '哈利·波特与密室'],
                'image': ['HarryPotterAndTheChamberOfSecrets.jpg', 'HarryPotterAndTheChamberOfSecrets.jpg'],
                'author': ['J.K. Rowling', 'J·K·罗琳']
            },
            {
                'title': ["Harry Potter and the Sorcerer's Stone", "哈利·波特与魔法石"],
                'image': ['HarryPotterAndTheSorcerersStone.jpg', 'HarryPotterAndTheSorcerersStone.jpg'],
                'author': ['J.K. Rowling', 'J·K·罗琳']
            },
            {
            ...
            },
            {
                ...
                'image': ['ASociologyOfFamilyLife.jpg', 'ASociologyOfFamilyLife.jpg'],
    ...
    },
    {
        ...
        'items': [
            ...
            },
            {
                ...
                'image': ['MiraclesOfTheNamiyaGeneralStore.jpg', 'MiraclesOfTheNamiyaGeneralStore.jpg'],
    ...
    },
    {
        ...
        'items': [
            ...
            },
            {
                ...
                'image': ['TenYearsOfBackpacking.jpeg', 'TenYearsOfBackpacking.jpeg'],
                'author': ['Xiao Peng', '小鹏']
            },
            {
                'title': ['Insight', '看见'],
